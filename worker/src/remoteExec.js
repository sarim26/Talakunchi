 ...
 */
function buildSshArgv(program, programArgs) {
...
export function resolveSpawnArgv(program, programArgs) {
 ...
 */
export function spawnBashScriptOverSsh(bashScript, opts) {
...
export function spawnWithRemotePolicy(program, programArgs, opts) {
